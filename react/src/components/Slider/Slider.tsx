...
function Slider({
  ...
  return (
    <div className="bg-[rgba(0,0,0,0.3)] border-1 border-[rgba(255,255,255,0.1)] text-white text-2xl w-[calc(28vw_-_2em)] h-30 p-3 pt-0 flex flex-col justify-end items-center rounded-[33.5px]">
